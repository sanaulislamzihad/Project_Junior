...
import { BookOpen, Files, CheckCircle, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex flex-col">
            ...
            <nav className="w-full bg-white/80 backdrop-blur-sm border-b border-slate-200 sticky top-0 z-50 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <button
                        onClick={onStart}
                        className="px-6 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-full font-medium transition-colors shadow-md shadow-sky-200"
                    >
                        Try It Now
                    </button>
                </div>
