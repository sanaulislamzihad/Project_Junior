...
const UploadZone = ({ onUpload, isAnalyzing, user, showHero = true, title = 'Upload your Document', description = 'Drag & drop or browse files', loadingLabel = 'Analyzing Document...', loadingSubLabel = 'Cross-checking against repository...' }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-1 w-full max-w-4xl mx-auto my-auto" style={showHero ? { minHeight: '80vh' } : undefined}>
            ...
            >
                ...
                {user?.role && (
                    <p className="mt-2 text-sm text-slate-500">
                        Adding to: <span className="font-medium text-sky-600">{repoLabel}</span>
                    </p>
                )}
            </motion.div>
            )}
